...
type InitialState = {
  // 배출예약 SV
  dischargeReserveSV: { id: string; name: string; value: number; unit: string };
  // 배출예약 PV
  dischargeReservePV: { id: string; name: string; value: number; unit: string };
  // 저장탱크 수위
  storageTankLevel: { id: string; name: string; value: number; unit: string };
  // 발효건조가열
